...
func (g geo) GeoSearchByCoord(longitude, latitude, radius float64, count int, withCoord bool, withDist bool, ascSort bool) []redis.GeoLocation {
	var sort string
	if ascSort {
		sort = "ASC"
	}
...
func (g geo) GeoSearchByMember(member string, radius float64, count int, withCoord bool, withDist bool, ascSort bool) []redis.GeoLocation {
	var sort string
	if ascSort {
		sort = "ASC"
	}
